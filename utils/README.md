...
All functions included in this directory, except the custom written ones add_gps_data and getLL.R, are taken directly from the R package momentuHMM (version 1.5.5) by Brett McClintock and Theo Michelot.
